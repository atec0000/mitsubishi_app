...
class _BluetoothwificonnectState extends State<Bluetoothwificonnect> {
  ...
  Future<void> _connectToDevice() async {
    ...
    try {
      EspBlufi.instance.sendRouterDataAndConnectSta(
          widget.wifiResult.ssid, _passwordController.text);
      // 连接成功后检查连接状态
      Navigator.push(
        context,
        MaterialPageRoute(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            const Text('Wi-Fi名稱 :', style: TextStyle(fontSize: 24)),
            Text(widget.wifiResult.ssid, style: const TextStyle(fontSize: 24)),
            TextField(
              ...
              decoration: InputDecoration(
                hintText: '輸入密碼',
                labelText: 'Password',
                labelStyle: const TextStyle(color: Colors.black), // 設置標籤文字的顏色
                hintStyle: TextStyle(
                    color: Colors.black.withOpacity(0.7)), // 設置提示文字的顏色
